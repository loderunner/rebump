...
// RegisterRebumpHandlerFromEndpoint is same as RegisterRebumpHandler but
// automatically dials to "endpoint" and closes the connection when "ctx" gets done.
func RegisterRebumpHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterRebumpHandler(ctx, mux, conn)
}

// RegisterRebumpHandler registers the http handlers for service Rebump to "mux".
// The handlers forward requests to the grpc endpoint over "conn".
func RegisterRebumpHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterRebumpHandlerClient(ctx, mux, NewRebumpClient(conn))
}

// RegisterRebumpHandler registers the http handlers for service Rebump to "mux".
// The handlers forward requests to the grpc endpoint over the given implementation of "RebumpClient".
// Note: the gRPC framework executes interceptors within the gRPC handler. If the passed in "RebumpClient"
